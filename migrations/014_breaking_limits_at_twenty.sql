-- Migration 014: #Phá vỡ giới hạn áp dụng từ 20 tín chỉ trở lên.

UPDATE achievement_definitions
SET
  description = 'Trong một học kỳ hoàn thành từ 20 tín chỉ và vẫn đạt GPA học kỳ từ 3.20.',
  rule_config = '{"minCredits": 20, "minGpa": 3.2}'::jsonb,
  updated_at = NOW()
WHERE id = 'breaking_limits';
